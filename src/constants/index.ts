...
import { HomeIcon, LiveIcon, MoviesIcon, SeriesIcon, FavIcon, WatchLaterIcon } from '../components/icons/NavIcons';
...
export const USER_AGENT = (Config && Config.USER_AGENT) || 'PusztaPlayer/0.7.0';

// ─── Hibanaplózás (Sentry) ──────────────────────────
// Állítsd be a saát DSN-ed itt: https://sentry.io/settings/projects/
export const SENTRY_DSN = (Config && Config.SENTRY_DSN) || 'https://7ba30c41ab9c695adda417b758b09915@o4511395172843520.ingest.de.sentry.io/4511395177234512';
export const USER_STATUS_LOGGED_IN = 'Xtream bejelentkezve';
export const DEFAULT_PROFILE_NAME = 'Profil';
export const DEFAULT_PLAYER_CONTENT_ID = 'royal';

// ─── Font family names (platform-aware) ──────────────
const isWin = Platform.OS === 'windows';
export const FONT_FAMILY_BANGERS = isWin ? 'Bangers' : 'Bangers-Regular';
export const FONT_FAMILY_POPPINS = isWin ? 'Poppins' : 'Poppins-Regular';
export const FONT_FAMILY_POPPINS_BOLD = isWin ? 'Poppins' : 'Poppins-Bold';
