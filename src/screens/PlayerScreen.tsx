...
import {  COLORS, FONT, SPACING, SIZES , FONT_FAMILY_BANGERS, FONT_FAMILY_POPPINS, FONT_FAMILY_POPPINS_BOLD } from '../constants';
  ...
  if (error) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.errorSub}>Stream URL: {session?.streamUrl?.slice(0, 60)}...</Text>
        <Pressable
    ...
    <View style={styles.container}>
      <View style={styles.videoContainer}>
        <VideoPlayer
          ...
          noVideo={showLogo}
          onBack={onBack}
          selectedTextTrack={selectedTextTrackIdx >= 0 ? { type: SelectedTrackType.INDEX, value: selectedTextTrackIdx } : undefined}
          selectedAudioTrack={selectedAudioTrackIdx > 0 ? { type: SelectedTrackType.INDEX, value: selectedAudioTrackIdx } : undefined}
...
const styles = StyleSheet.create({
  ...
  countdownText: { color: COLORS.white, fontSize: FONT.lg, fontFamily: FONT_FAMILY_BANGERS },
  countdownNum: { color: COLORS.yellow, fontSize: 80, fontFamily: FONT_FAMILY_BANGERS },
