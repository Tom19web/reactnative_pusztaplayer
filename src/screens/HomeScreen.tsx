...
const styles = StyleSheet.create({
  ...
  yellowHeaderText: { color: COLORS.black, fontFamily: FONT_FAMILY_BANGERS, fontSize: 18, letterSpacing: 0.5, textAlign: 'left' },
  subHeader: { color: COLORS.white, fontFamily: FONT_FAMILY_BANGERS, fontSize: 16, marginTop: SPACING.sm, marginBottom: SPACING.xs * 2 },
  ...
  clearBtnText: { color: COLORS.white, fontSize: 11, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
});
