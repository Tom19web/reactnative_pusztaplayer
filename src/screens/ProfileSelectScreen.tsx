...
import { FONT_FAMILY_BANGERS, FONT_FAMILY_POPPINS, FONT_FAMILY_POPPINS_BOLD } from '../constants';
      ...
      <ScrollView contentContainerStyle={s.gridScroll} nestedScrollEnabled>
        ...
        {(() => { const deletedProfs = profiles.filter(p => p.deleted); return deletedProfs.length > 0 ? (
          <View style={{ marginTop: 24, width: '100%', maxWidth: 600 }}>
            <Text style={{ color: '#555', fontSize: 12, fontFamily: FONT_FAMILY_POPPINS_BOLD, textTransform: 'uppercase', letterSpacing: 2, marginBottom: 12, textAlign: 'center' }}>Törölt profilok</Text>
            <View style={s.profileGrid}>
              {deletedProfs.map(p => (
                <TFPressable
                  key={p.id}
                ...
                >
                  <PopArtCard shadowOffset={4} borderRadius={12} borderWidth={2} contentStyle={s.restoreCard}>
                    ...
                    <Text style={{ color: '#555', fontSize: 11, fontFamily: FONT_FAMILY_POPPINS_BOLD, textAlign: 'center' }}>{p.name}</Text>
                    <Text style={{ color: '#1fd6e8', fontSize: 8, fontFamily: FONT_FAMILY_POPPINS_BOLD, marginTop: 4, textTransform: 'uppercase' }}>Visszaállítás</Text>
                  </PopArtCard>
                </TFPressable>
              ))}
            </View>
...
const s = StyleSheet.create({
  ...
  title: { color: '#f6c800', fontSize: 42, fontFamily: FONT_FAMILY_BANGERS, letterSpacing: 3, textShadowColor: '#000', textShadowOffset: { width: 4, height: 4 }, textShadowRadius: 0 },
  subtitle: { color: '#555', fontSize: 10, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 3, textTransform: 'uppercase', marginTop: 4 },
  ...
  confirmText: { color: '#fff', fontSize: 15, fontFamily: FONT_FAMILY_POPPINS_BOLD, flex: 1 },
  ...
  confirmNoText: { color: '#fff', fontSize: 13, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  confirmYesText: { color: '#000', fontSize: 13, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  profileName: { color: '#fff', fontSize: 15, fontFamily: FONT_FAMILY_POPPINS_BOLD, textAlign: 'center', marginBottom: 6 },
  activeTag: { color: '#f6c800', fontSize: 10, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 1, textTransform: 'uppercase' },
  ...
  addText: { color: '#333', fontSize: 44, fontFamily: FONT_FAMILY_BANGERS },
  emptyCard: { width: Math.min(400, Dimensions.get('window').width - 120), paddingVertical: 32, paddingHorizontal: 28, alignItems: 'center' },
  emptyTitle: { color: '#fff', fontSize: 18, fontFamily: FONT_FAMILY_POPPINS_BOLD, textAlign: 'center' },
  emptySub: { color: '#777', fontSize: 14, fontFamily: FONT_FAMILY_POPPINS, marginBottom: 24, marginTop: 6 },
  ...
  stepLabel: { color: '#888', fontSize: 12, fontFamily: FONT_FAMILY_POPPINS_BOLD, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 16 },
  input: { alignSelf: 'stretch', backgroundColor: '#0d0d0d', borderRadius: 10, borderWidth: 3, borderColor: '#1a1a1a', paddingVertical: 14, paddingHorizontal: 16, color: '#fff', fontSize: 16, fontFamily: FONT_FAMILY_POPPINS, marginBottom: 12 },
  ...
  btnDiceText: { color: '#999', fontSize: 13, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  btnPrimaryText: { color: '#000', fontSize: 14, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 1, textTransform: 'uppercase' },
  ...
  btnSecondaryText: { color: '#fff', fontSize: 14, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 1 },
