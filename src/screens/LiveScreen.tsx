...
const styles = StyleSheet.create({
  ...
  filterBox:{position:'relative',backgroundColor:COLORS.yellow,borderRadius:0,paddingVertical:SPACING.sm,paddingHorizontal:SPACING.lg,flexDirection:'row',alignItems:'center',gap:SPACING.md,overflow:'hidden'},
