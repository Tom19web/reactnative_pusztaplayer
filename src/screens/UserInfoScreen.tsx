...
const s = StyleSheet.create({
  ...
  title: { color: '#f6c800', fontSize: 27, fontFamily: FONT_FAMILY_BANGERS, letterSpacing: 3, textShadowColor: '#000', textShadowOffset: { width: 4, height: 4 }, textShadowRadius: 0 },
  subtitle: { color: '#555', fontSize: 8, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 3, textTransform: 'uppercase', marginTop: 1 },
  divider: { height: 2, backgroundColor: '#1a1a1a', alignSelf: 'stretch', marginVertical: 5 },
  columns: { flexDirection: 'row', gap: 20 },
  column: { flex: 1 },
  sectionHeader: { color: '#555', fontSize: 8, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 2, textTransform: 'uppercase' },
  ...
  label: { color: '#777', fontSize: 10, fontFamily: FONT_FAMILY_POPPINS },
  value: { color: '#fff', fontSize: 10, fontFamily: FONT_FAMILY_POPPINS_BOLD, textAlign: 'right', maxWidth: '55%' },
  ...
  badgeText: { fontSize: 8, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 0.5 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0a0a0a', padding: 20 },
  errText: { color: '#ff4d57', fontSize: 11, fontFamily: FONT_FAMILY_POPPINS_BOLD, marginBottom: 6 },
  ...
  backBtnText: { color: '#fff', fontSize: 11, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  miniAvatarText: { color: '#000', fontSize: 9, fontFamily: FONT_FAMILY_BANGERS },
  profileChipName: { color: '#fff', fontSize: 9, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  logoutBtnText: { color: '#fff', fontSize: 12, fontFamily: FONT_FAMILY_POPPINS_BOLD, letterSpacing: 1 },
});
