...
export function EpgIcon({ size = 24, color = '#1a1a1a' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48">
      <Rect x="3" y="6" width="42" height="36" rx="3" fill={bg} stroke={color} strokeWidth={3} />
      <Path d="M3 14 L45 14" stroke={color} strokeWidth={2} />
      <Path d="M14 14 L14 42" stroke={color} strokeWidth={2} />
      <Path d="M28 14 L28 42" stroke={color} strokeWidth={1} opacity={0.5} />
      <Path d="M3 22 L14 22 M3 30 L14 30 M3 38 L14 38" stroke={color} strokeWidth={1} opacity={0.3} />
      <Rect x="18" y="18" width="8" height="10" rx="1" fill={color} opacity={0.7} />
      <Rect x="32" y="26" width="8" height="12" rx="1" fill={color} opacity={0.7} />
    </Svg>
  );
}
