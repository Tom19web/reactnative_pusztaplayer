...
const styles = StyleSheet.create({
  ...
  tooltipText: { color: COLORS.yellow, fontSize: FONT.xs - 2, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  channelTitle: { color: COLORS.yellow, fontSize: Math.round(FONT.md * 1.75) - 2, fontFamily: FONT_FAMILY_BANGERS, letterSpacing: 0.5, paddingBottom: 2, flex: 1 },
  resText: { color: COLORS.cyan, fontSize: FONT.sm - 2, fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  channelNowLabel: { color: COLORS.cyan, fontSize: Math.round(FONT.sm * 1.5) - 4, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
  channelNow: { color: COLORS.white, fontSize: Math.round(FONT.sm * 1.5) - 4, fontFamily: FONT_FAMILY_POPPINS, flex: 1 },
  channelTime: { color: COLORS.muted, fontSize: Math.round(FONT.sm * 1.5) - 4, fontFamily: FONT_FAMILY_POPPINS },
  channelNext: { color: COLORS.cyan, fontSize: Math.round(FONT.sm * 1.5) - 4, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD, minWidth: 20 },
  channelNextTitle: { color: COLORS.white, fontSize: Math.round(FONT.sm * 1.5) - 4, fontFamily: FONT_FAMILY_POPPINS, flex: 1 },
  ...
  epgDesc: { color: COLORS.muted, fontSize: Math.round(FONT.sm * 1.2) - 4, fontFamily: FONT_FAMILY_POPPINS, lineHeight: Math.round(FONT.sm * 1.4), paddingLeft: 2, marginTop: 2 },
  chanNavRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, marginTop: 4 },
  chanNavText: { color: COLORS.muted, fontSize: FONT.xs + 2, fontFamily: FONT_FAMILY_POPPINS },
  ...
  vodPlot: { color: COLORS.text, fontSize: Math.round(FONT.sm * 1.1) - 2, lineHeight: Math.round(FONT.sm * 1.6), fontFamily: FONT_FAMILY_POPPINS },
  ...
  settingsLabel: { color: COLORS.muted, fontSize: 10, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD, minWidth: 40 },
  ...
  settingsChipText: { color: COLORS.muted, fontSize: 9, fontWeight: '600', fontFamily: FONT_FAMILY_POPPINS },
