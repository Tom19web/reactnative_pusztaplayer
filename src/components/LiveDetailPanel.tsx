...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    fontFamily: FONT_FAMILY_BANGERS, letterSpacing: 1,
  },
  group: { fontSize: 8, color: COLORS.muted, marginTop: 4, fontFamily: FONT_FAMILY_POPPINS },
  ...
  qualityBtnText: { color: COLORS.muted, fontSize: 9, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
  ...
  btnPlayText: { color: COLORS.black, fontSize: 10, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
  btnFav: {
