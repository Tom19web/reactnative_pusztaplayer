...
const styles = StyleSheet.create({
  ...
  icon: { fontSize: 64 },
  title: { color: COLORS.yellow, fontFamily: 'Bangers-Regular', fontSize: FONT.xl, letterSpacing: 0.5 },
  ...
  btnText: { color: COLORS.black, fontFamily: 'Poppins-Bold', fontSize: FONT.md },
});
