...
export default function HomeHero({ history, playlist, onPlayContent }: HomeHeroProps) {
  ...
  useEffect(() => {
    ...
    timerRef.current = setInterval(() => goTo(currentIdx + 1), INTERVAL);
...
const slideStyles = StyleSheet.create({
  ...
  badgeText: { color: COLORS.black, fontSize: 7, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
  title: { color: COLORS.white, fontSize: 24, fontFamily: FONT_FAMILY_BANGERS, letterSpacing: 1, flex: 1, marginRight: 8 },
  ...
  playBtnText: { color: COLORS.black, fontSize: 10, fontWeight: '700', fontFamily: FONT_FAMILY_POPPINS_BOLD },
  favBtn: {
