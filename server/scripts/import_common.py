...
_EPG_SOURCES: dict[str, list[str]] = {
    "at": [
        ...
        "https://iptv-epg.org/files/epg-at.xml",
    ],
    "de": [
    ...
    "ch": [
        ...
        "https://iptv-epg.org/files/epg-ch.xml",
    ],
    "fr": ["https://www.open-epg.com/files/france.xml"],
    "it": [
        "https://www.open-epg.com/files/italy.xml",
        "https://www.free-epg.de/api/epg/rytec/it.xml",
    ...
    "ro": [
        "https://www.open-epg.com/files/romania.xml",
        "https://www.free-epg.de/api/epg/rytec/ro.xml",
    ...
    "hu": [
        "https://iptv-epg.org/files/epg-hu.xml",
    ],
